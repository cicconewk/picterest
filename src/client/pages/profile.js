  ...
  render() {
    return (
      <Fragment>
        <Header />
        <main role="main">
          <div className="jumbotron border-round-0 min-50vh" style={{backgroundImage: "url(https://purple11.com/static/a82977acdc9179a08c5e7a968a823125/21153/surreal-teal-sky-cover3.jpg)"}}>
          </div>
